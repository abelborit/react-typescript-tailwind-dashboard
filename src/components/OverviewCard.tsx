...
export const OverviewCard = ({ overviewInfo }: OverviewCardProps) => {
  ...
  return (
    <div className="bg-Light-Grayish-Blue dark:bg-Dark-Desaturated-Blue w-[265px] h-[215px] rounded-lg overflow-hidden mx-auto shadow-md hover:brightness-95 hover:dark:brightness-125 cursor-pointer">
