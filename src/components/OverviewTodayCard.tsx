...
export const OverviewTodayCard = ({
  ...
  return (
    <div className="bg-Light-Grayish-Blue dark:bg-Dark-Desaturated-Blue w-[265px] h-[115px] rounded-lg overflow-hidden mx-auto shadow-md hover:brightness-95 hover:dark:brightness-125 hover:scale-105 transition-all cursor-pointer">
